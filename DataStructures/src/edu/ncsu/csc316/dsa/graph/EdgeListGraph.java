...
public class EdgeListGraph<V, E> extends AbstractGraph<V, E> {
	...
	/** Vertex list for EdgeListGraph */
    private PositionalList<Vertex<V>> vertexList;
    /** Edge list for EdgeListGraph */
    ...
    /** 
     * Safely casts a Vertex as a GraphVertex
     * @param v Vertex to cast
     * @return Vertex as a GraphVertex
     */
    ...
    /** 
     * Returns the list of outgoing Edges from vertex
     *  
    ...
    /**
     * Returns the list of incoming Edges from vertex
     * 
     * @param vertex vertex to check
