 ...
 * worst-case performance for {at see Map#put}, {at see Map#get}, and
 * {at see Map#remove}.
 *
...
public class AVLTreeMap<K extends Comparable<K>, V> extends BinarySearchTreeMap<K, V> {
     ...
     * @param compare Comparator to use for comparisons
     */
    ...
    private void rebalance(Position<Entry<K, V>> p) {
    	...
    	do {
    		...
    		if(!isBalanced(x)) {
    			...
    			// save the root of the restructured subtree as p
