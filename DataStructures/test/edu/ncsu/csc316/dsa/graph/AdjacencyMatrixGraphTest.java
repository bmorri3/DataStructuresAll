 ...
 * an adjacency matrix graph data structure
 *
 * @author Ben Morris
 *
 */
public class AdjacencyMatrixGraphTest {
    ...
    /**
     * Create a new instance of an AdjacencyMatrixGraph before each test case executes
     */ 
    @Before
    public void setUp() {
    ...
    /**
     * Building an unidirected graph to test
     */
    ...
    /**
     * Building a directed graph to test
     */
    ...
    public void testEdges() {
        ...
        assertTrue(it.hasNext());
        assertEquals((Integer) 5, it.next().getElement());
        assertTrue(it.hasNext());
        assertEquals("Edge[element=10]", it.next().toString());
        assertTrue(it.hasNext());
    ...
    public void testGetEdge() {
        ...
        // Test a nonexistent edge
        assertNull(undirectedGraph.getEdge(v4, v6));
    ...
    public void testEndVertices() {
        ...
        // Test nonexistent endVertices
        assertNotEquals(v6, undirectedGraph.endVertices(e1));        
        
        // Test existing endVertices
        Vertex<String>[] endpoints;
        endpoints = (Vertex<String>[]) new Vertex[] {v1, v2};
        assertEquals(endpoints, undirectedGraph.endVertices(e1));
        endpoints = (Vertex<String>[]) new Vertex[] {v2, v4};
        assertEquals(endpoints, undirectedGraph.endVertices(e6));
        ...
        // Test existing endVertices
        endpoints = (Vertex<String>[]) new Vertex[] {v1, v3};
        assertEquals(endpoints, directedGraph.endVertices(e2));
        endpoints = (Vertex<String>[]) new Vertex[] {v5, v6};
        assertEquals(endpoints, directedGraph.endVertices(e11));
    }
    ...
    public void testOpposite() {
        ...
        try {
			undirectedGraph.opposite(v6, e1);
		} catch (Exception e) {
