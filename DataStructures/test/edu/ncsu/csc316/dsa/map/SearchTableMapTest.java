...
public class SearchTableMapTest {
    ...
    public void testRemove() {
        ...
        assertEquals("SearchTableMap[1, 2, 4]", map.toString());
        assertEquals(3, map.size());
        
        assertEquals("string2", map.remove(2));
        assertEquals("SearchTableMap[1, 4]", map.toString());
        assertEquals(2, map.size());
    ...
    /**
     * Test the output of the key iterator behavior, including expected exceptions
     */ 
    @Test
