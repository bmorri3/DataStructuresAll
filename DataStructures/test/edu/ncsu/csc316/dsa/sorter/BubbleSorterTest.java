...
/**
 * Class to test BubbleSorter with various generic classes and Student
 * @author Dr. King
 * @author Ben Morris
 */
...
public class BubbleSorterTest {
	...
	/** Testing using a file and student manager and BubbleSort*/
	@Test
	public void testFileStudentManagerBubble() {
		
		BubbleSorter<Student> sorter = new BubbleSorter<Student>();
