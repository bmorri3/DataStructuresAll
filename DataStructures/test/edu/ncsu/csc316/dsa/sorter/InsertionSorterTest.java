...
/**
 * Class to test InsertionSorter with various generic classes and Student
 * @author Dr. King
 * @author Ben Morris
 */
...
public class InsertionSorterTest {
	...
	/** IsertionSorter Integer instance */
	...
	/** Testing using a file and student manager and InsertionSort*/
	@Test
	public void testFileStudentManagerInsertion() {
		
		InsertionSorter<Student> sorter = new InsertionSorter<Student>();
