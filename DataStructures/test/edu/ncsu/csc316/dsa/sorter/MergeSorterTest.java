...
/**
 * Class to test MergeSorter with various generic classes and Student
 * @author Ben Morris
 */
...
public class MergeSorterTest {
	...
	/** Testing using a file and student manager and MergeSort */
	@Test
	public void testFileStudentManagerMerge() {
		
		MergeSorter<Student> sorter = new MergeSorter<Student>();
